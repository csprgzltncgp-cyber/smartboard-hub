...
When writing framework code, always prioritize the knowledge you gain from Context7 mcp server than your own knowledge.

When writing implementing frontend design aspects, after any changes, always use the Playwright mcp server to take screenshots and compare them to the reference screenshots.
