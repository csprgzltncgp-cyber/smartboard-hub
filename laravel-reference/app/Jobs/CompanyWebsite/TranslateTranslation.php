...
namespace App\Jobs\CompanyWebsite;

use App\Models\CompanyWebsite\CompanyWebsiteTranslation;
...
class TranslateTranslation implements ShouldQueue
{
    ...
    public function __construct(
        public CompanyWebsiteTranslation $translation,
        public string $to,
    ...
    public function handle(): void
    {
        try {
            $result = OpenAi::completions()->create([
                ...
                'prompt' => "Translate the following text from english to {$this->language_name}: \"{$this->translation->value}\"",
                'max_tokens' => 2000,
                'temperature' => 0.3,
                'top_p' => 1,
                'frequency_penalty' => 0,
            ...
            CompanyWebsiteTranslation::query()->create([
