...
@section('content')
    <div class="row">
        <div class="col-12">
            {{ Breadcrumbs::render('workshops.filter') }}
            <h1>{{__('workshop.filter')}}</h1>
            <form method="get" class="row" action="{{route('admin.workshops.result')}}">
                <div class="filter-holder col-6">
                    <div class="filter">
                        <p>{{__('workshop.workshop_serial_number')}}</p>
                        ...
                        <div class="options d-none">
                            <input type="text" name="activity_id"
                                   placeholder="{{__('workshop.workshop_serial_number')}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 mt-5 mb-5 d-flex justify-content-between align-items-end">
                    <a class="back-button" href="{{ route('admin.workshops.list') }}">{{__('common.back-to-list')}}</a>
