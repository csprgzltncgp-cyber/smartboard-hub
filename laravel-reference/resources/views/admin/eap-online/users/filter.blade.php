...
@section('content')
    <div class="row">
        <div class="col-12">
            {{ Breadcrumbs::render('eap-online.users.filter') }}
            <h1>{{__('workshop.filter')}}</h1>
            <form method="post" class="row" action="{{route('admin.eap-online.users.filter.result')}}">
                @csrf
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                        ...
                        <div class="options d-none">
                            <input type="text" name="username"
                                   placeholder="{{__('eap-online.users.username')}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="filter-holder col-6">
                    <div class="filter">
                        <p>{{__('eap-online.languages.country')}}</p>
                        <button type="button" class="filter-button"><svg xmlns="http://www.w3.org/2000/svg" style="height: 30px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                </svg></button>
                        <div class="options d-none">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                        ...
                        <div class="options d-none">
                            <input type="text" name="email"
                                   placeholder="{{__('eap-online.users.email')}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 mt-5 mb-5 d-flex justify-content-between align-items-end">
                    <a class="back-button"
                       href="{{ route('admin.eap-online.users.list') }}">{{__('common.back-to-list')}}</a>
