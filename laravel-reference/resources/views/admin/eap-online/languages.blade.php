...
@section('content')
    <div class="row">
        <div class="col-12 mb-5">
            {{ Breadcrumbs::render('eap-online.languages') }}
            <h1>{{__('eap-online.languages.title')}}</h1>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{route('admin.eap-online.languages')}}">
                        <input type="text" placeholder="{{__('eap-online.languages.name')}}"
                               name="name">
                        <input type="text" placeholder="{{__('eap-online.languages.country_code')}}"
                               name="code">
                        {{csrf_field()}}
