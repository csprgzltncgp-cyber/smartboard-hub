...
@section('content')
    <div class="row">
        <div class="col-12 mb-5">
            {{ Breadcrumbs::render('eap-online.video-therapy.actions.expert_day_off.edit') }}
        ...
        <div class="row col-12">
            ...
            <div class="col-12">
                    <form class="mw-100" action="{{route(auth()->user()->type . '.eap-online.video_therapy.actions.expert_day_off.timetable_edit')}}" method="get">
                        {{csrf_field()}}
