...
@section('content')
    <div class="row">
        <div class="col-12">
            {{ Breadcrumbs::render('eap-online.mails.filter') }}
            <h1>{{__('workshop.filter')}}</h1>
            <form method="post" class="row" action="{{route('admin.eap-online.mails.filter.result')}}">
                @csrf
                ...
                <div class="col-12 mt-5 mb-5 d-flex justify-content-between align-items-end">
                    <a class="back-button"
                       href="{{ route('admin.eap-online.mails.list') }}">{{__('common.back-to-list')}}</a>
