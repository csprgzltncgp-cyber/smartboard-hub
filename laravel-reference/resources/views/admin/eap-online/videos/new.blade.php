...
@section('extra_js')
    ...
    <script type="text/javascript">
        ...
        const category_trans = "{{__('eap-online.videos.all_videos')}}";
        const short_title_trans = "{{__('eap-online.videos.short_title')}}";
        const long_title_trans = "{{__('eap-online.videos.long_title')}}";
        const link_trans = "{{__('eap-online.videos.link')}}";
        const required_trans = "{{__('eap-online.required')}}";
        let main_categories = @json(\App\Models\EapOnline\EapCategory::where('type', 'all-videos')->get()->pluck('id')->toArray())
    </script>
    ...
    <script src="/assets/js/eap-online/video_validator.js?v={{time()}}" charset="utf-8"></script>
...
@section('content')
    <div class="row">
        <div class="col-12">
            {{ Breadcrumbs::render('eap-online.videos.create') }}
            <h1>{{__('eap-online.videos.add')}}</h1>
        </div>
        <div class="col-12">
            <form action="{{route('admin.eap-online.videos.new')}}" method="post" class="mb-5" style="max-width: 100%"
                ...
                <div class="row d-flex flex-column col-12">
                    <h1 class="mb-3">{{__('eap-online.articles.appearance')}} <span id="visibility_alt"
                                class="h5">{{__('eap-online.videos.visibility_alt')}}</span></h1>
                    ...
                    <label class="container checkbox-container"
                           id="customer-satisfaction-not-possible">{{__('eap-online.videos.all_languages')}}
                        <input type="radio" name="all_languages" value="1"
                               @if(!empty(old('all_languages'))) checked @endif
                        >
                ...
                <div class="row d-flex col-12">
                    <div class="d-flex flex-column col-6 row">
                        ...
                        <div class="d-flex align-items-center ml-n2">
                            ...
                            <span id="uploaded-file-name">{{__('eap-online.videos.attachment_placeholder')}}</span>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-5 w-100">
                                <input oninput="removeError('error-text', 'download-button-text')" class="mb-0"
                                       ...
                                       value="{{old('download-button-text')}}"
