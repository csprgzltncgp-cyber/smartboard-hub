...
@section('content')
    <div class="row m-0 w-100">
        {{ Breadcrumbs::render('other-activities.filtered') }}
        <h1 class="col-12 pl-0">{{__('workshop.filter_result')}}</h1>
        <ul id="workshop-submenus" class="w-100">
            <li class="mr-0">
                <a class="col-12 pl-0 d-block add-new-workshop btn-radius" href="{{route('admin.other-activities.filter')}}">
                    ...
                    </svg>{{__('workshop.apply_filter')}}
                </a>
            </li>
            <li class="ml-0">
                <a class="col-12 pl-0 d-block add-new-workshop btn-radius" href="{{route('admin.other-activities.index')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-1" style="width:20px; height:20px" fill="none"
                         viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              d="M4 6h16M4 10h16M4 14h16M4 18h16"/>
                    </svg>{{__('other-activity.all')}}
                </a>
            </li>
        </ul>

        @if(!$other_activities->count())
