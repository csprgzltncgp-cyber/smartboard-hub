...
@section('content')
    <div class="row">
        <div class="col-12">
            {{ Breadcrumbs::render('crisis.filter') }}
            <h1>{{__('crisis.filter')}}</h1>
            <form method="get" class="row" action="{{route('admin.crisis.result')}}">
                <div class="filter-holder col-6">
                    <div class="filter">
                        <p>{{__('crisis.crisis_serial_number')}}</p>
                        ...
                        <div class="options d-none">
                            <input type="text" name="activity_id"
                                   placeholder="{{__('crisis.crisis_serial_number')}}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="filter">
                        ...
                        <div class="options d-none">
                            <select name="expert_id">
                                <option value="">{{__('crisis.select')}}</option>
                ...
                <div class="col-12 mt-5 mb-5 d-flex justify-content-between align-items-end">
                    <a class="back-button" href="{{ route('admin.crisis.list') }}">{{__('common.back-to-list')}}</a>
