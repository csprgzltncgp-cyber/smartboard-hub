...
<li><a href="{{route('production_admin.submenu.digital')}}">{{__('common.digital')}}</a></li>
@if(auth()->user()->connected_account == null)
    <li class='d-flex justify-content-between align-items-center'>
        <a href="{{route('production_admin.dashboard')}}">TODO</a>
        <li><a href="{{route('production_admin.assets.menu')}}">{{__('common.assets')}}</a></li>
        <div>
