...
<div class="row col-12 d-flex align-items-center mt-5">
    <div class="d-flex flex-column col-12 p-0 row pb-10">
        <div class="col-12 d-flex">
            <input name="country[{{$country->id}}][{{$company->id}}][company_id]" class="mr-3" type="hidden"
                   value="{{$company->id}}"
                   readonly>
            <div class="form-group w-25 mr-3">
                <label>{{__('workshop.company_name')}}</label>
                <input class="mr-3 mb-0 btn-input-field-height" type="text" value="{{$company->name}}"
                       readonly>
            </div>

            <input name="country[{{$country->id}}][{{$company->id}}][country_id]" class="mr-3" type="hidden"
                   value="{{$country->id}}"
                   readonly>
            <div class="form-group w-25 mr-3">
            ...
            <div class="form-group w-25 mr-3">
                ...
                <input name="country[{{$country->id}}][{{$company->id}}][email]" class="mr-3 mb-0 btn-input-field-height" type="email"
            ...
            <div class="form-group w-25 mr-3">
                ...
                <input name="country[{{$country->id}}][{{$company->id}}][phone]" class="mr-3 mb-0 btn-input-field-height" type="text"
            ...
            <div class="form-group w-25">
                ...
                <button onclick="deleteContactInfo({{$contact_info->id}})"
                        class="text-center w-auto ml-5 btn-radius" style="margin-top: 10px; --btn-height:48px; --btn-min-width: auto; --btn-padding-x: 15px" type="button">
        ...
        <div class="col-12 d-flex">
            <div class="form-group w-25 mr-3">
                <label class="container checkbox-container"
                    ...
                    <input type="hidden" name="country[{{$country->id}}][{{$company->id}}][phone_card]"
                           value="disabled">
                    <input type="checkbox" name="country[{{$country->id}}][{{$company->id}}][phone_card]"
            ...
            <div class="form-group w-25 mr-3">
                <label class="container checkbox-container"
                    ...
                    <input type="hidden" name="country[{{$country->id}}][{{$company->id}}][email_card]"
                           value="disabled">
                    <input type="checkbox" name="country[{{$country->id}}][{{$company->id}}][email_card]"
            ...
            <div class="form-group w-25 mr-3">
                <label class="container checkbox-container"
                    ...
                    <input type="hidden" name="country[{{$country->id}}][{{$company->id}}][chat_card]" value="disabled">
                    <input type="checkbox" name="country[{{$country->id}}][{{$company->id}}][chat_card]"
