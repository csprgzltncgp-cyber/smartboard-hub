<div class="search-container">
    <div class="order-holder">
        <svg xmlns="http://www.w3.org/2000/svg" style="heigth:20px; width:20px;" class="mr-1" fill="none"
    ...
    <div class="search-holder">
        <div class="green-box btn-radius button-c" style="--btn-height: auto; --btn-margin-bottom: 0px;">
        ...
        <div class="green-box btn-radius button-c"
            style="--btn-height: auto; --btn-margin-left: var(--btn-margin-x); --btn-margin-bottom: 0px; margin-right: 0px!important;"
