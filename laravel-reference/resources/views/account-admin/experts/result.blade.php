...
@section('content')
    <div class="row m-0 w-100">
        ...
        <ul id="workshop-submenus" class="row ml-0 w-100">
            <li class="mr-0"><a class="col-12 pl-0 d-block add-new-workshop btn-radius" href="{{route('account_admin.experts.filter')}}">
            ...
            <li><a class="col-12 pl-0 d-block add-new-workshop btn-radius" href="{{route('account_admin.experts.index')}}">
        ...
        @foreach($users as $expert)
            <div class="list-element col-12">
                ...
                <a style="padding: 10px 10px; margin-bottom:0;" class="float-right" href="{{route('account_admin.experts.show', ['user' => $expert])}}">
