@push('livewire_js')
    ...
    <script>
        ...
        $( document ).ready(function() {
            @if($all_company)
                $("#companies_select_cont").hide();
                $("#countries_select_cont").hide();
            @endif
        });
        ...
        Livewire.on('errorEvent', function(message){
            Swal.fire({
        ...
        $("#languages").chosen().change(function(e) {
            @this.set('live_webinar.eap_languages', $(e.target).val());
        });
...
<div class="row">
    ...
    <div class="row col-12">
        <div class="col-12">
            {{ Breadcrumbs::render('eap-online.live-webinars.edit', $live_webinar) }}
            <h1>{{ __('eap-online.live-webinars.edit') }}</h1>
            ...
            <form class="col-5 ml-0 pl-0">
                ...
                <div class="mb-1 mt-3" style="border: 2px solid rgb(89,198,198) !important;">
                    <div class="d-flex flex-row align-items-center pl-2">
                        ...
                        <select wire:model="live_webinar.language_id" class="chosen-select" style="margin: 0px 0px 0px 10px !important; padding: 10px 0px 10px 0px !important; border:0px!important; color:black!important">
                ...
                <div class="mb-1 mt-3" style="border: 2px solid rgb(89,198,198) !important;">
                    <div class="d-flex flex-row align-items-center pl-2">
                        ...
                        <select required wire:model="live_webinar.permission_id" style="margin: 0px 0px 0px 10px !important; padding: 10px 0px 10px 0px !important; border:0px!important; color:black!important">
                            <option value="" selected hidden>{{__('common.please-choose-one')}}</option>
                            @if ($permissions)
                ...
                <div class="mb-1 mt-3" style="border: 2px solid rgb(89,198,198) !important;">
                    <div class="d-flex flex-row align-items-center pl-2">
                        ...
                        @if ($experts)
                        <select required wire:model="live_webinar.user_id" style="margin: 0px 0px 0px 10px !important; padding: 10px 0px 10px 0px !important; border:0px!important; color:black!important">
                            <option value="" selected hidden>{{__('common.please-choose-one')}}</option>
                ...
                <div class="mb-1 mt-3" style="border: 2px solid rgb(89,198,198) !important;" wire:ignore>
                    <div class="d-flex flex-row align-items-center pl-2">
                        ...
                        <input id="from" type="text" wire:ignore style="width:50% !important; margin-bottom: 0 !important; border: 0px !important; background-color: transparent !important; color: black !important;">
                    </div>
                </div>
                <div class="mb-1 mt-3" style="border: 2px solid rgb(89,198,198) !important;" wire:ignore>
                    <div class="d-flex flex-row align-items-center pl-2">
                ...
                @if($live_webinar->zoom_passcode)
                    <div class="mb-1 mt-3" style="border: 2px solid rgb(89,198,198) !important;" wire:ignore>
                        <div class="d-flex flex-row align-items-center pl-2">
                            <span class="mr-1" style="color: rgb(89, 198, 198);">{{ __('eap-online.live-webinars.passcode') }}:</span>
                            <input readonly type="text" value="{{ $live_webinar->zoom_passcode }}" style="margin-bottom: 0 !important; border: 0px !important; background-color: transparent !important; color: black !important;  width: 50% !important">
                        </div>
                    </div>
                @endif
                <div class="mb-1 mt-3" style="border: 2px solid rgb(89,198,198) !important;" wire:ignore>
                ...
                <div class="d-flex flex-row w-100 ml-0 mt-3">
                    <input type="text" style="margin-right:15px!important;" placeholder="@if(empty($live_webinar->image)){{__('prizegame.gallery.photo')}} (jpg, jpeg, png max. 2 MB) @else{{basename($live_webinar->image)}}@endif" disabled>
                    <div class="justify-content-end {{empty($live_webinar->image) ? 'd-flex' : 'd-none'}}">
                    ...
                    <div class="justify-content-end {{empty($live_webinar->image) ? 'd-none' : 'd-flex '}}">
                ...
                @if($live_webinar->image)
                    <div class="d-flex flex-row ml-0">
                        <img class="col-12 h-100" src="{{asset('assets/' . $live_webinar->image)}}" alt="preview" style="border:2px solid rgb(89,198,198); border-radius: 1rem; width:200px; height:200px; padding:0; object-fit:cover;">
                    </div>
                @endif
