...
<div>
    ...
    {{ Breadcrumbs::render('experts.create') }}

    <h1>{{__('common.create-expert')}}</h1>

    <form wire:submit.prevent='store' style="max-width: 750px !important;">
        ...
        <div style="margin-bottom:50px">
            ...
            <div class="input-group col-12 p-0">
                ...
                <input type="email" wire:model='user.email' required>
            </div>
                        ...
                        <div class="input-group col-12 p-0">
                            ...
                            <select  class="col-12" wire:model="expertData.phone_prefix">
                                ...
                                @foreach($phonePrefixes as $phonePrefix)
                                    <option value="{{$phonePrefix['code']}}">{{$phonePrefix['code']}} {{$phonePrefix['dial_code']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
        ...
        <div style="margin-bottom:70px">
            ...
            <div class="input-group col-12 p-0 @if (!$expertPermissions) d-none @endif">
                <div class="input-group-prepend">
                    <div class="input-group-text">
            ...
            <div class="form-row @if (!$expertPermissions) d-none @endif">
                @if($invoiceData->invoicing_type)
                    ...
                    <div class="form-group col-md-12 mb-0">
                        <div class="d-flex flex-column">
                            <div class="input-group col-12 p-0">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        {{__('invoice.hourly_rate_50')}}:
                                    </div>
                                </div>
                                <input type="{{$hidden_prices ? 'password' : 'text'}}" class="col-12" wire:model='invoiceData.hourly_rate_50' required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-12 mb-0">
                            <div class="d-flex flex-column">
                                <div class="input-group col-12 p-0">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            {{__('invoice.hourly_rate_30')}}:
                                        </div>
                                    </div>
                                    <input type="{{$hidden_prices ? 'password' : 'text'}}" class="col-12" wire:model='invoiceData.hourly_rate_30' required>
                                </div>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="form-group col-md-12 mb-0">
                        <div class="d-flex flex-column">
                            <div class="input-group col-12 p-0">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        {{__('invoice.fixed_wage')}}:
                                    </div>
                                </div>
                                <input type="{{$hidden_prices ? 'password' : 'text'}}" class="col-12" wire:model='invoiceData.fixed_wage' required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-12 mb-0">
                        <div class="d-flex flex-column">
                            <div class="input-group col-12 p-0">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        {{__('invoice.ranking_hourly_rate')}}:
                                    </div>
                                </div>
                                <input type="{{$hidden_prices ? 'password' : 'text'}}" class="col-12" wire:model='invoiceData.ranking_hourly_rate' required>
                            </div>
                        </div>
                    </div>
                @endif
                    ...
                    <div class="form-group col-md-12 mb-0">
                        <div class="d-flex flex-column">
                            <div class="input-group col-12 p-0">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        {{__('invoice.single_session_rate')}}:
                                    </div>
                                </div>
                                <input type="{{$hidden_prices ? 'password' : 'text'}}" class="col-12" wire:model='invoiceData.single_session_rate' required>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                @if (!empty($custom_invoice_items))
                    ...
                    @foreach ($custom_invoice_items as $invoice_item)
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3 mb-0">
                                <input type="text" class="col-12" placeholder="{{ $countries->where('id',$invoice_item['country_id'])->first()->name }}" disabled>
                            </div>
            ...
            <div class="form-row {{$expertData->is_cgp_employee || !$expertPermissions ? 'd-none' : ''}}">
                <div class="form-group col-md-8 mb-0 pr-0">
                    <input type="text" class="col-12" placeholder="{{__('expert-data.scanned-contract')}}" disabled>
                </div>
                <div class="form-group col-md-4 mb-0 pl-0">
                    <button type="button" id="uploadContract" style="--btn-height: 48px; --btn-margin-left: var(--btn-margin-x)" class="text-center btn-radius">
            ...
            <div class="{{count($contracts) ? 'mb-5' : ''}} {{$expertData->is_cgp_employee || !$expertPermissions ? 'd-none' : ''}}">
                @if(count($contracts))
                    @foreach($contracts as $id => $contract)
                        <div class="form-row">
                            <div class="form-group col-md-6 pr-0">
                                <input type="text" class="col-12 dark" placeholder="{{$contract->getClientOriginalName()}}" disabled>
                            </div>
                            <div class="form-group col-md-6 pl-0">
                                <button wire:click="removeFileFromTempContracts({{$id}})" type="button" style="background: rgb(0,87,95); --btn-height: 48px; --btn-margin-left: var(--btn-margin-x)" class="text-center btn-radius">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-1" style="width:20px; height:20px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                    {{__('common.cancel')}}
            ...
            <div class="form-row {{$expertData->is_cgp_employee || !$expertPermissions ? 'd-none' : ''}}">
                <div class="form-group col-md-8 mb-0 pr-0">
                    <input type="text" class="col-12" placeholder="{{__('expert-data.scanned-certificate')}}" disabled>
                </div>
                <div class="form-group col-md-4 mb-0 pl-0">
                    <button id="uploadCertificate" type="button" style="--btn-height: 48px; --btn-margin-left: var(--btn-margin-x)" class="text-center btn-radius">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mr-1" style="width:20px; height:20px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                        </svg>
                        {{__('common.upload')}}
            ...
            <div  class="{{count($certificates) ? 'mb-5' : ''}} {{$expertData->is_cgp_employee || !$expertPermissions ? 'd-none' : ''}}">
                @if(count($certificates))
                    @foreach($certificates as $id => $certificate)
                        <div class="form-row">
                            <div class="form-group col-md-6 pr-0">
                                <input type="text" class="col-12 dark" placeholder="{{$certificate->getClientOriginalName()}}" disabled>
                            </div>
                            <div class="form-group col-md-6 pl-0">
                                <button wire:click="removeFileFromTempCertificates({{$id}})" type="button" style="background: rgb(0,87,95); --btn-height: 48px; --btn-margin-left: var(--btn-margin-x)" class="text-cente btn-radius">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mr-1" style="width:20px; height:20px;" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                        </svg>
                                    {{__('common.cancel')}}
            ...
            <div class="form-group @if (!$expertPermissions) d-none @else d-block @endif">
                <div class="input-group col-12 p-0" wire:ignore>
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                            {{__('common.country')}}:
            ...
            <div class="form-group @if (!$expertPermissions) d-none @endif">
                <div class="input-group col-12 p-0" wire:ignore>
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                            {{__('crisis.city')}}:
        ...
        <div style="margin-bottom:70px" class="{{$expertData->is_eap_online_expert ? '' : 'd-none'}}">
            ...
            <div class="d-flex flex-row w-100 ml-0">
                <input type="text" style="margin-right:15px!important;" placeholder="{{__('prizegame.gallery.photo')}}" disabled>
                <div class="justify-content-end {{empty($eapOnlinePhoto) ? 'd-flex' : 'd-none'}}">
                ...
                <div class="justify-content-end {{empty($eapOnlinePhoto) ? 'd-none' : 'd-flex '}}">
                    <button type="button" wire:click="$set('eapOnlinePhoto', null)" style="--btn-height:48px; --btn-margin-right: 0px"
                        class="text-center btn-radius">
                        <svg xmlns="http://www.w3.org/2000/svg" class="mr-1" style="width:20px; height:20px;"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @if(!empty($eapOnlinePhoto))
                <div class="form-row">
                    <div class="form-group" style="padding: 0 5px;">
                        <img class="col-12" src="{{$eapOnlinePhoto->temporaryUrl()}}" alt="preview" style="border:2px solid rgb(89,198,198); border-radius: 1rem; width:200px; height:200px; padding:0; object-fit:cover;">
                    </div>
                </div>
            @endif
            ...
            <div class="input-group col-12 p-0">
                <textarea wire:model="eapOnlineData.description" maxlength="180" rows="10" class="mr-0" placeholder="{{__('expert-data.description')}}"></textarea>
            </div>
        </div>
