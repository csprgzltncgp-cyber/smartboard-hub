...
@section('content')
    <div class="row mt-5 w-100">
        ...
        <ul id="workshop-submenus" class="w-100">
            <li>
                <a class="col-12 pl-0 d-block add-new-workshop btn-radius" href="{{route('operator.eap-online.mails.filter.view')}}">
            ...
            <li>
                <a class="col-12 pl-0 d-block add-new-workshop btn-radius" href="{{route('operator.eap-online.mails.list')}}">
