...
use App\Http\Controllers\Admin\PsychosocialRiskAssessmentController;
use App\Http\Controllers\Admin\RiportController;
use App\Http\Controllers\Admin\RiportExportController;
...
Route::get('/register/admin', (new AdminController)->register(...));
Route::post('/register/admin', (new AdminController)->register_process(...));
...
Route::prefix('/admin')->group(function (): void {
    Route::name('admin.')->group(function (): void {
        ...
        Route::middleware(['is_logged_in', 'user_type:admin', '2fa'])->group(function (): void {
            ...
            Route::prefix('/eap-online')->name('eap-online')->group(function (): void {
                ...
                Route::prefix('/categories')->name('.categories')->group(function (): void {
                    Route::prefix('/list')->name('.list')->group(function (): void {
                        ...
                        Route::get('/all-webinars', (new EapCategoriesController)->list_all_webinars_type(...))->name('.all-webinars');
                ...
                Route::prefix('/chat')->group(function (): void {
                    Route::get('/{client_id}/{room_id}', (new ChatController)->index(...))->name('.online_chat');
                    Route::post('/typing', (new ChatController)->typing(...))->name('.online_chat_typing');
                    Route::post('/', (new ChatController)->store(...))->name('.online_chat_store');
                });
                /* CHAT */
            ...
            Route::prefix('/psychosocial-risk-assessment')->group(function (): void {
                Route::name('psychosocial-risk-assessment')->group(function (): void {
                    Route::get('/list', (new PsychosocialRiskAssessmentController)->index(...))->name('.list');
                    Route::get('/download_ivy_summary', (new PsychosocialRiskAssessmentController)->download_ivy_summary(...))->name('.download_ivy_summary');
                    Route::get('/download_exxon_summary', (new PsychosocialRiskAssessmentController)->download_exxon_summary(...))->name('.download_exxon_summary');
                    Route::get('/download_schott_summary', (new PsychosocialRiskAssessmentController)->download_schott_summary(...))->name('.download_schott_summary');
                });
            });
            /* PSYCHOSOCIAL RISK ASSESSMENT */
            ...
            Route::prefix('/companies')->group(function (): void {
                Route::name('companies')->group(function (): void {
                    ...
                    Route::post('/inputs/{input_id}/values/{company_id}', (new CompaniesController)->input_values_process(...));
            ...
            Route::prefix('/riports')->group(function (): void {
                Route::name('riports')->group(function (): void {
                    Route::post('/export', (new RiportExportController)->contract_holder(...))->name('.export');
                    Route::post('/export/custom-company', (new RiportExportController)->download_custom_company_riport(...))->name('.download_custom_company_riport');
                    Route::post('/export/company-summarize', (new RiportExportController)->company_summarize(...))->name('.company-summarize');
                    Route::get('/download/company-summarize/{filename}', (new RiportExportController)->download_summarized_riport(...))->name('.download-company-summarize');
